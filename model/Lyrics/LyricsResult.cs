...
internal sealed record LyricsResult
{
    ...
    private LyricsResult(LyricsResultType resultType, string? artistName = null, string? lyrics = null, string? url = null, string? errorMessage = null)
    {
    ...
    internal static LyricsResult CreateMatch(LyricsResultType lyricsResultType, string artistName, string lyrics, string url) => new(lyricsResultType, artistName, lyrics, url);
}
